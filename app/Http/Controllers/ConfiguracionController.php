...
class ConfiguracionController extends Controller
{
    ...
    public function logoGobierno(Request $request,$id)
    {
      try{
        $configuracion = \App\Configuracion::find($id);
        /*if($configuracion->escudo_alcaldia!=''){
          ...
          $archivo="logo_gobierno_".date("Y-m-d-h-i-s-a").".".$request->file('logo')->getClientOriginalExtension();
          $request->file('logo')->storeAs('public/logos', $archivo);
          //$request->file('logo')->move('img/logos', $archivo);
          $configuracion->escudo_gobierno=$archivo;
          $configuracion->save();
        //}
