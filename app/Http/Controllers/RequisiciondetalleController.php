...
class RequisiciondetalleController extends Controller
{
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <h4 class="modal-title" id="myModalLabel">Editar detalles del insumo</h4>
                    </div>
                      ...
                      <form id="form_editar_eldetalle" class="form-horizontal">
                        ...
                        <div class="form-group">
                          <label for="" class="col-md-4 control-label">Descripcion</label>
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="nombre" readonly value="'.$requisicion->material->nombre.'"> 
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                          <input name="unidad_medida" value="'.$requisicion->unidad_medida.'" class="form-control"> 
                          </div>
                        </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <button type="button" id="editar_eldetalle" class="btn btn-success">Guardar</button></center>
                    </div>
                  </div>
                  </div>
                </div>';
    ...
    public function update(RequisiciondetalleRequest $request,$id)
    {
        try{
            ...
            $requisiciondetalle->unidad_medida=$request->unidad_medida;
            $requisiciondetalle->cantidad=$request->cantidad;
