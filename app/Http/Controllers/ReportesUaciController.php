...
class ReportesUaciController extends Controller
{
    ...
    public function proveedor()
    {
      ...
      $configuracion=\App\Configuracion::first();
    	$pdf = \PDF::loadView('pdf.uaci.proveedor',compact('proveedores','tipo','configuracion'));
    ...
    public function ordencompra($id)
    {
      ...
      $configuracion=\App\Configuracion::first();
    	...
    	$pdf = \PDF::loadView('pdf.uaci.ordencompra',compact('ordencompra','tipo','configuracion'));
    	$pdf->setPaper('letter','portrait');
