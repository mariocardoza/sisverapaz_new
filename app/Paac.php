...
class Paac extends Model
{
    ...
    public static function show($id){
        ...
        if($paac->estado==1):
          $html.='<a href="javascript:void(0)" id="registrar" title="Agregar elementos" class="btn btn-success"><span class="glyphicon glyphicon-plus-sign"></span></a>
        <br><br>';
        endif;
              ...
              <tbody>';
                ...
                $html.='<tr>
                  ...
                  if($paac->estado==1):
                    $html.='<td>
                    <div class="btn-group">
                    <a href="javascript:void(0)" data-id="'.$detalle->id.'" id="eleditar" title="Editar" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                    <a href="javascript:void(0)" title="Dar de baja" class="btn btn-danger btn-sm" id="eliminar" data-id="'.$detalle->id.'"><i class="fa fa-thumbs-o-down"></i></a>
                  </div>
                  </td>';
                  endif;
                  $html.='</tr>';
