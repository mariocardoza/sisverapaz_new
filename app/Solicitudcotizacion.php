  ...
  use DatesTranslator;
    ...
    public static function modal_cotizacion($id){
      ...
      $proveedores= DB::table('proveedors as p')
        ->whereNotExists(function ($query) use($id) {
             $query->from('cotizacions as c')
                ->whereRaw('c.solicitudcotizacion_id ='.$id)
                ->whereRaw('c.proveedor_id = p.id');
            })->get();
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Registrar Precios Unitarios</h4>
          </div>
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="registrar_lacoti" class="btn btn-success">Guardar</button></center>
          </div>
        </div>
        </div>
      </div>';
      ...
      try{
        ...
        $html.='<div class="panel">
                  ...
                  <br><br>
                    ...
                    <br><br>  
                    <div class="col-sm-2">
                      <a class="btn btn-primary vista_previa" title="Imprimir solicitud de cotización" target="_blank" href="../reportesuaci/solicitud/'.$solicitud->id.'"><i class="fa fa-print"></i></a>
                    </div>
                    </fieldset>
                  </div>
                  <br>
                  ...
                  if($solicitud->requisicion->conpresupuesto ==1):
                    ...
                    $html.='<button class="btn btn-success pull-right" title="Agregar precios unitarios a insumos" type="button" id="registrar_cotizacion" data-id="'.$solicitud->id.'"><i class="fa fa"></i>Agregar</button>';
                    endif;
                  else:
                  ...
                  if(isset($solicitud->cotizacion_seleccionada)):
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <a class="btn btn-primary vista_previa" title="Imprimir orden de compra" target="_blank" href="../reportesuaci/ordencompra/'.$solicitud->cotizacion_seleccionada->ordencompra->id.'"><i class="fa fa-print"></i></a>
                      </div>
                    </div>
                    </fieldset>
                    <br><br>';
                    ...
                    $html.='<fieldset>
                    <legend>Acta de Recepción de Bienes y Servicios</legend>
                    <center>
                      <a title="Imprimir acta de recepción" href="../reportesuaci/acta/'.$solicitud->cotizacion_seleccionada->ordencompra->id.'" class="btn btn-primary vista_previa" target="_blank"><i class="fa fa-print"></i></a>
                    </center>
                    </fieldset>';
                    endif;
                    $html.='</div>';
                    else:
                      $html.='<button type="button" id="registrar_orden" class="btn btn-success" title="Registrar cotización" data-id="'.$solicitud->cotizacion_seleccionada->id.'">Agregar</button>';
                    endif; 
                  endif;
                      $html.'</div>
                    </div>';
        ...
        $html.='<div class="panel">
                  ...
                  if(isset($solicitud->cotizacion_seleccionada) && $solicitud->proyecto->estado>=6):
                    ...
                    $html.='</div>';
                      ...
                      <button type="button" id="registrar_orden" title="Registrar orden de compra" class="btn btn-success" data-id="'.$solicitud->cotizacion_seleccionada->id.'">Agregar</button>';
                    endif; 
                  endif;
                      $html.'</div>
                    </div>';
    ...
    public static function formulario_solicitud($id)
    {
      ...
      <div class="form-group">
        ...
        <div class="col-md-2">
          <button type="button" class="btn btn-success" title="Agregar nueva forma de pago" id="" data-toggle="modal" data-target="#modalformapago"><span class="fa fa-plus-circle"></span></button>
        </div>
      </div>
      ...
      <table class="table table-striped" id="tabla" display="block;">
          ...
          $formulario.='</tbody>
            ...
            <div class="form-group">
              <center>
                <button id="cancelar_soli" class="btn btn-danger">Cancelar</button>
    ...
    public static function formulario_solicitudr($id)
    {
      ...
      $formulario.='<div>
        <div class="panel panel-primary">
          <div class="panel-heading">Registro de Solicitudes para Cotización</div>
          <div class="panel-body">
          <form class="form-horizontal" id="form_solicitudcotizacion">
      ...
      <div class="form-group">
        ...
        <div class="col-md-2">
          <button type="button" class="btn btn-success btn-sm" title="Agregar nueva forma de pago" id="add_formaPago" data-toggle="modal" data-target="#modalformapago"><span class="fa fa-plus-circle"></span></button>
        </div>
      </div>
    ...
    public static function solicitud($id)
    {
      ...
      try{
        ...
        $html.='<div class="panel">
                  ...
                  <legend>Cotizaciones';
                    if($solicitud->estado==1):  
                    $html.='<button class="btn btn-success btn-sm" type="button" id="registrar_cotizacion" data-id="'.$solicitud->id.'"><i class="fa fa-plus-circle"></i></button>';
                    endif;
                  ...
                  if(isset($solicitud->cotizacion_seleccionada)):
                    ...
                    $html.='</div>';
                      ...
                      $html.='<button type="button" id="registrar_orden" class="btn btn-success" title="Registrar orden de compra" data-id="'.$solicitud->cotizacion_seleccionada->id.'">Agregar</button>';
                    endif; 
                  endif;
                      $html.'</div>
                    </div>';
