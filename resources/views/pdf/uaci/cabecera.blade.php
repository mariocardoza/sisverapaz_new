    ...
    <table width="100%">
      <tr>
        ...
        <td>
          ...
          <p class="text-center " style="font-size:13px;color:#155CC2;" >UNIDAD DE ADQUISICIONES Y CONTRATACIONES INSTITUCIONALES</p>
          <p class="text-center " style="color:#155CC2;"> - UACI - </p>
