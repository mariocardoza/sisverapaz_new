...
@else
<div class="titulo" style="z-Index:7;left:18%;top:4%;width:50%;height:5%;">Verapaz</div>
    <div class="titulo" style="z-Index:7;left:56%;top:4%;width:50%;height:5%;">{{$partida->fecha_pago->format("d")}}</div>
    <div class="titulo" style="z-Index:7;left:62%;top:4%;width:50%;height:5%;">{{$partida->fecha_pago->format("F")}}</div>
    <div class="titulo" style="z-Index:7;left:82%;top:4%;width:50%;height:5%;">{{$partida->fecha_pago->format("Y")}}</div>
@endif

    <div class="FRX1_11" style="z-Index:7;left:1.93292in;
top:0.96667in;width:1.38542in;height:0.17708in;">${{number_format($partida->total,2)}}</div>
    <div class="FRX1_11" style="z-Index:7;left:1in;
top:1.26667in;width:2.0in;height:1.17708in;">{{$partida->nombre}}</div>

<div class="FRX1_11" style="z-Index:7;left:1in;
top:1.86667in;width:1.78542in;height:1.17708in;">{{num_letras(number_format($partida->total,2))}}</div>
@if($partida->tipo==1)
<div class="FRX1_11" style="z-Index:7;left:3in;
top:1.86667in;width:1.58542in;height:1.57708in;">Emisión de partida de nacimiento</div>
@endif

<div class="FRX1_11" style="z-Index:7;left:5in;
top:1.86667in;width:1.58542in;height:1.57708in;">${{number_format($partida->monto,2)}}</div>

<div class="FRX1_11" style="z-Index:7;left:3in;
top:2.96667in;width:1.58542in;height:1.57708in;">{{retornar_porcentaje("fiestas")*100}}% Fiestas</div>

<div class="FRX1_11" style="z-Index:7;left:5in;
top:2.96667in;width:1.58542in;height:1.57708in;">${{number_format($partida->monto*retornar_porcentaje('fiestas'),2)}}</div>


<div class="FRX1_11" style="z-Index:7;left:5in;
top:5.96667in;width:1.58542in;height:1.57708in;">${{number_format($partida->total,2)}}</div>
</body>
</html>