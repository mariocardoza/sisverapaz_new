...
<div class="row">
    <div class="col-md-12" style="text-align: center;">
        <div class="btn-group" data-toggle="buttons">
            <label class="btn btn-primary active">
              <input type="radio" name="tipo_cuenta" value="3" id="tipo_cuenta1" checked> Común
            </label>
            <label class="btn btn-primary">
              <input type="radio" name="tipo_cuenta" value="1" id="tipo_cuenta2"> Principal
            </label>
            <label class="btn btn-primary">
              <input type="radio" name="tipo_cuenta" value="2" id="tipo_cuenta3"> Fiestas
            </label>
        </div>
    </div>
    <br><br>
    <div class="col-md-6">
        <div class="form-group{{ $errors->has('nombre') ? ' has-error' : '' }}">
            ...
            <div class="">
                {{ Form::text('nombre', null,['id'=>'nombre','class' => 'form-control','autocomplete'=>'off']) }}
