...
<div class="">
    <div class="row">
        <div class="col-md-9">
          <div id="elshow">
            <div class="btn-group">
              <button  title="Detalles de ésta requisición" class="btn btn-primary que_ver" data-tipo="1">Requisición</button>
              @if(Auth()->user()->hasRole('uaci'))
              <button title="Solicitudes para ésta requisición" class="btn btn-primary que_ver" data-tipo="2">Solicitudes</button>
              <button title="Contratos para ésta requisición" class="btn btn-primary que_ver" data-tipo="3">Contratos</button>
              @endif
            </div><br><br>
