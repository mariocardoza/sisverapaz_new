...
<ol class="breadcrumb">
	...
	<li><a href="{{ url('/eventuales') }}"><i class="fa fa-dashboard"></i>Eventuales</a></li>
...
<div class="row">
	<div class="col-md-12" >
		...
		@for($i=0;$i<2;$i++)
			...
			@endif
			<div class="panel-heading">Pagos empleados eventuales</div>
			<div class="panel-body">
		{{ Form::open(['action'=> 'EventualController@store', 'class' => 'form-horizontal']) }}
		<div class="row">
			<div class="col-md-6">
