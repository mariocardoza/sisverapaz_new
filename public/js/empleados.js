...
// para imagenes
	...
	$(document).on("click","#modal_afp",function(e){
		e.preventDefault();
		$("#modal_afps").modal("show");
	});
	...
	$(document).on("click","#modal_numisss",function(e){
		e.preventDefault();
		$(".title_isss").text("Agregar Número de ISSS");
		$("#modal_isss").modal("show");
	});
	...
	$(document).on("click","#editar_cuentas",function(e){
		e.preventDefault();
		$("#editar_bankinfo").modal("show");
	});
	$(document).on("click","#editar_afp",function(e){
		e.preventDefault();
		$("#editar_datoafp").modal("show");
	});
	$(document).on("click","#editar_isss",function(e){
		e.preventDefault();
		$(".title_isss").text("Editar número ISSS");
		$("#modal_isss").modal("show");
	});
	...
	$(document).on("click","#registrar_bancarios", function(e){
		...
		if(valid){
			...
			$.ajax({
				...
				success: function(json){
					if(json[0]==1){
					toastr.success("Dato registrado con éxito");
					window.location.reload();
					}else{
						toastr.error("Ocurrió un error");
						swal.closeModal();
	...
	$(document).on("click","#registrar_afps", function(e){
		e.preventDefault();
		var valid=$("#n_afp").valid();
		if(valid){
			modal_cargando();
			var datos=$("#n_afp").serialize();
			$.ajax({
				url:'../empleados/afps',
				headers: {'X-CSRF-TOKEN':eltoken},
				type:'POST',
				...
				success: function(json){
					if(json[0]==1){
					toastr.success("Datos de AFP registrados con éxito");
					window.location.reload();
				}else{
					toastr.error("Ocurrió un error");
					swal.closeModal();
				...
				$.each(
					error.responseJSON.errors,function(index,value){
					toastr.error(value);
				});
				swal.closeModal();
			}
	...
	$(document).on("click","#registrar_isss", function(e){
		var valid=$("#n_isss").valid();
		if(valid){
			var datos=$("#n_isss").serialize();
			$.ajax({
				url:'../empleados/isss',
				headers: {'X-CSRF-TOKEN':eltoken},
				type:'POST',
				...
				success: function(json){
				if(json[0]==1){
					toastr.success("Dato de ISSS registrado con éxito");
					window.location.reload();
				}else{
					toastr.error("Ocurrió un error");
				}
	...
	$(document).on("click","#eledit_user", function(e){
		...
		if(valid){
			...
			$.ajax({
				...
				success: function(json){
					if(json[0]==1){
					toastr.success("Datos de usuario actualizados con éxito");
					window.location.reload();
					}else{
						toastr.error("Ocurrió un error");
						swal.closeModal();
	...
	$(document).on("click","#eledit_banco", function(e){////////////
		e.preventDefault();
		var valid=$("#e_bancos").valid();
		if(valid){
			modal_cargando();
			var datos=$("#e_bancos").serialize();
			$.ajax({
				url:'/empleados/ebancos',///////////////
				headers: {'X-CSRF-TOKEN':eltoken},
				type:'POST',
				dataType:'json',
				data:datos,
				success: function(json){
					if(json[0]==1){
					toastr.success("Dato bancarios actualizados");
					window.location.reload();
					}else{
						toastr.error("Ocurrió un error");
						swal.closeModal();
	...
	$(document).on("click","#eledit_afp", function(e){
		e.preventDefault();
		//var valid = $("#e_afp").valid();
		//if(valid){
			modal_cargando();
			var datos = $("#e_afp").serialize();
			$.ajax({
				url:'/empleados/afps',
				headers: {'X-CSRF-TOKEN':eltoken},
				type:'POST',
				...
				success: function(json){
					if(json[0]==1){
						toastr.success("Dato de AFP actualizado");
						window.location.reload();
					}else{
						toastr.error("Ocurrió un error");
						swal.closeModal();
	...
	$(document).on("click","#eledit_isss", function(e){
		var valid = $("#e_isss").valid();
		if(valid){
			modal_cargando();
			var datos = $("#e_isss").serialize();
			$.ajax({
				url:'/empleados/eisss',
				headers: {'X-CSRF-TOKEN':eltoken},
				type:'POST',
				...
				success: function(json){
					if(json[0]==1){
						toastr.success("Dato de ISSS actualizado");
						window.location.reload();
					}else{
						toastr.error("Ocurrió un error");
						swal.closeModal();
